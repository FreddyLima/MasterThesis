...
#echo python experiments/${study_path}/plot_static.py $study $experiments $runs $generations $comparison $outputs_path;
python experiments/${study_path}/plot_joints.py $study $experiments $runs $generations $comparison $outputs_path;
