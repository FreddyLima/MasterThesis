...
class LocalRunner(Runner):
    ...
    def __init__(
        ...
        self._record_settings = '/home/fdelima/thesis/storage'
    ...
    def _run_environment(
        ...
        while (time := data.time) < simulation_time:
            ...
            if time >= last_control_time + control_step:
                ...
                if i >= len(joints_off):
                    i = 0
                # print("TARGET BEFORE", control_user._dof_targets)
                env_descr.controller.control(control_step, control_user, 'open', np.array([0,0,0,0,0,0,0,0]), joints_off[i])
                # print("TARGET AFTER", control_user._dof_targets)
    ...
    def _make_model(env_descr: Environment) -> mujoco.MjModel:
        ...
        env_mjcf.option.gravity = [0, 0, -1.62]
        #1.62
        #9.807
